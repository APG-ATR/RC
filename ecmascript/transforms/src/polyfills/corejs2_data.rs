...
pub const ARRAY_NATURE_ITERATORS :&[&str]=& [
    "es6.object.to-string",
    "es6.array.iterator",
    "web.dom.iterable",
];

pub const COMMON_ITERATORS = ["es6.string.iterator", ...ARRAY_NATURE_ITERATORS];

const PROMISE_DEPENDENCIES = ["es6.object.to-string", "es6.promise"];

pub const BUILT_INS: ObjectMap<string | string[]> = {
...
pub const INSTANCE_PROPERTIES: ObjectMap<string[]> = {
...
pub const STATIC_PROPERTIES: ObjectMap<ObjectMap<string | string[]>> = {
Array: {
